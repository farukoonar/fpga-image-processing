...
HD_PWD='C:/Users/faruk/exp_7/exp_7.runs/bram_red_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_red.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_red.tcl
