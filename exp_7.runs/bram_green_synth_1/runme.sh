...
HD_PWD='C:/Users/faruk/exp_7/exp_7.runs/bram_green_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_green.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_green.tcl
