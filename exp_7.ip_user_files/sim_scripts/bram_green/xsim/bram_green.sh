...
#
# Script generated by Vivado on Fri Dec 12 14:56:47 +0300 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_green.sh
...
#
# Usage        : bram_green.sh
#                bram_green.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_green.sh [-reset_run]
#                bram_green.sh [-reset_log]
#                bram_green.sh [-help]
#
...
# script info
echo -e "bram_green.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_green.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_green xil_defaultlib.bram_green xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_green -key {Behavioral:sim_1:Functional:bram_green} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_green.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_green.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_green.sh [-help]\n\
Usage: bram_green.sh [-step]\n\
Usage: bram_green.sh [-lib_map_path]\n\
Usage: bram_green.sh [-reset_run]\n\
Usage: bram_green.sh [-reset_log]\n\
Usage: bram_green.sh [-keep_index]\n\
Usage: bram_green.sh [-noclean_files]\n\n\
